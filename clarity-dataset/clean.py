...
FILLER_PHRASES = ["what i'm trying to say is", "at the end of the day", "you know what i'm saying",
                  "as some people said", "as some people say", "as i was saying", "thank you very much",
                  "it's kind of like", "that being said", "having said that", "in other words",
                  "by the way", "the thing is", "the point is", "the fact is", "i mean like", "sort of like",
                  "kind of like", "i'd say that", "i feel like", "to be honest", "to be frank", "to be clear",
                  "to be fair" "as you know", "as i said", "as i say",
                  "like you said", "like you say", "like i said", "like i say", "in a sense", "if you will",
                  "you know what", "more or less", "all right", "you know", "i mean", "kind of", "sort of", "you see",
                  "i guess", "i suppose", "i think", "let's say",
                  "it's like", "and stuff", "and things", "or something", "thank you", "thanks", ]
BOUNDARY_FILLERS = ["literally", "basically", "actually", "anyways", "anyway", "please", "listen", "though", "still",
                    "right", "look", "like", "okay", "ok", "well", "now", "so", ]
